...
class EventDashboard extends Component {
  ...
  // In lecture 37: Selecting Event to Open
  // get data from eventlistitem arrow function into arrow function
  // double arrow is so that we don't have to make one in the render method
